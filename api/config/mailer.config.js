...
module.exports.sendActivationEmail = (data) => {
transporter.sendMail({
    from: `'Nodemailer Test' <${process.env.NM_USER}>`,
    to: 'josesietepicos@gmail.com',
    ...
    <style type="text/css">
      ...
      <div style="font-family:Arial;font-size:18px;line-height:1;text-align:center;color:#000000;">Name:<br> ${data.name}</div>
              ...
              <tr>
              <td align="center" style="font-size:0px;padding:0 25px;padding-top:30px;word-break:break-word;">                  
    <div style="font-family:Arial;font-size:18px;line-height:1;text-align:center;color:#000000;">Message:<br> ${data.message}</div>
               </td>
            </tr>  
      </table>    
                </td>
